...
class Enemy : public Entity {
	// Now the game have the only type of monsters - Chaotic Being. They have no goals in their life, they just wander on the map.
...
public:
	...
	// controls enemy's movement according to direction of movement which changes randomly on "crossing tiles" with limited frequency
